...
import { CheckCircleIcon, EyeIcon, EyeSlashIcon, XCircleIcon } from "@/components/icons";
    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 text-sm font-semibold text-zinc-500 dark:text-zinc-400">
          Study smarter. Pass the PTCB exam.
        </p>
      </div>
      ...
      <div className="mt-8 rounded-3xl border border-zinc-200/70 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
        ...
        <p className="mt-1 text-sm font-semibold text-zinc-500 dark:text-zinc-400">
          Start your learning path in seconds.
        </p>
        ...
        {message && (
          <motion.div
            initial={{ opacity: 0, scale: 0.97 }}
            animate={{ opacity: 1, scale: 1 }}
            className="mt-4 flex items-start gap-2 rounded-2xl border border-brand/30 bg-brand-soft px-4 py-3 text-sm font-semibold text-brand-strong dark:bg-brand/15 dark:text-brand"
          >
